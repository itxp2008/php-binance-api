...
class API
{
     ...
     * @throws \Exception
     */
    public function chart($symbols, callable $callback = null, string $interval = "30m", $limit = 500)
    {
        if (is_null($callback)) {
     ...
     * @throws \Exception
     */
    public function kline($symbols, string $interval = "30m", callable $callback = null, string $interval = "30m")
    {
        if (is_null($callback)) {
            throw new Exception("You must provide a valid callback");
        }
